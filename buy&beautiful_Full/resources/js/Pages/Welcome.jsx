                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                    ...
                    <div className="relative group">
                        ...
                        <div className="sidebar absolute hidden group-hover:block top-full left-0 w-full bg-white p-4 shadow-md z-10">
                            ...
                            <ul className="space-y-4">
                                <li><a href={route('register')} className="text-pink-500 hover:underline">Eyes</a></li>
                                <li><a href={route('register')} className="text-pink-500 hover:underline">Face</a></li>
                                <li><a href={route('register')} className="text-pink-500 hover:underline">Lips</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="relative group">
                        ...
                        <div className="sidebar absolute hidden group-hover:block top-full left-0 w-full bg-white p-4 shadow-md z-10">
                            <h3 className="text-lg font-bold text-pink-600 mb-4">Categories</h3>
                            <ul className="space-y-4">
                                <li><a href={route('register')} className="text-pink-500 hover:underline">Facial Care</a></li>
                                <li><a href={route('register')} className="text-pink-500 hover:underline">Body Care</a></li>
                            </ul>
                        </div>
                    </div>
