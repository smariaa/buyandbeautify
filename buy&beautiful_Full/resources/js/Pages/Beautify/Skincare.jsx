...
import imggg8 from "../../../imggg/8.jpeg"
import imggg9 from "../../../imggg/9.jpeg"
import imggg10 from "../../../imggg/10.jpeg"
import imggg11 from "../../../imggg/11.jpeg"
import imggg12 from "../../../imggg/12.jpeg"
import imggg13 from "../../../imggg/13.jpeg"
import imggg14 from "../../../imggg/14.jpeg"
        ...
        <div className="bg-pink-50 font-sans leading-normal tracking-normal flex flex-col min-h-screen">
            ...
            <header className="bg-pink-500 text-white p-4">
                <div className="flex justify-between items-center">
                    <h1 className="text-3xl font-bold">SKINCARE</h1>
            ...
            <main className="max-w-5xl mx-auto p-6 space-y-12">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                    ...
                    <div className="relative group">
                        <img src={imggg8} alt="Product 1" className="w-full rounded-lg shadow-md" />
                    ...
                    {/* Product 2 */}
                    <div className="relative group">
                        <img src={imggg9} alt="Product 2" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 3 */}
                    <div className="relative group">
                        <img src={imggg10} alt="Product 3" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 4 */}
                    <div className="relative group">
                        <img src={imggg11} alt="Product 4" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                     ...
                     {/* Product 5 */}
                     <div className="relative group">
                        <img src={imggg12} alt="Product 5" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 6 */}
                    <div className="relative group">
                        <img src={imggg13} alt="Product 6" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 7 */}
                    <div className="relative group">
                        <img src={imggg14} alt="Product 7" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
