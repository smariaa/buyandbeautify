        ...
        <div className="bg-pink-50 font-sans leading-normal tracking-normal flex flex-col min-h-screen">
            ...
            <header className="bg-pink-500 text-white p-4">
                <div className="flex justify-between items-center">
                    <h1 className="text-3xl font-bold">LIPS</h1>
            ...
            <main className="max-w-5xl mx-auto p-6 space-y-12">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                    ...
                    <div className="relative group">
                        <img src="/assets/img/a.png" alt="Product 1" className="w-full rounded-lg shadow-md" />
                    ...
                    {/* Product 2 */}
                    <div className="relative group">
                        <img src="/assets/img/e.png" alt="Product 2" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 3 */}
                    <div className="relative group">
                        <img src="/assets/img/d.png" alt="Product 3" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 4 */}
                    <div className="relative group">
                        <img src="/assets/img/d.png" alt="Product 4" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
