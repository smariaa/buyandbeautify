...
import imgg13 from "../../../imgg/13.jpeg";
import imgg14 from "../../../imgg/14.jpeg";
import imgg16 from "../../../imgg/16.jpeg";
import imgg17 from "../../../imgg/17.jpeg";
        ...
        <div className="bg-pink-50 font-sans leading-normal tracking-normal flex flex-col min-h-screen">
            ...
            <header className="bg-pink-500 text-white p-4">
                <div className="flex justify-between items-center">
                    <h1 className="text-3xl font-bold">EYES</h1>
            ...
            <main className="max-w-5xl mx-auto p-6 space-y-12">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                    ...
                    <div className="relative group">
                        <img src={imgg13} alt="Product 1" className="w-full rounded-lg shadow-md" />
                    ...
                    {/* Product 2 */}
                    <div className="relative group">
                        <img src={imgg14} alt="Product 2" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 3 */}
                    <div className="relative group">
                        <img src={imgg16} alt="Product 3" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 4 */}
                    <div className="relative group">
                        <img src={imgg17} alt="Product 4" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
