            ...
            <main className="max-w-5xl mx-auto p-6 space-y-12">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                    ...
                    <div className="relative group">
                        <img src={imgg1} alt="Product 1" className="w-full rounded-lg shadow-md" />
                    ...
                    {/* Product 2 */}
                    <div className="relative group">
                        <img src={imgg2} alt="Product 2" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 3 */}
                    <div className="relative group">
                        <img src={imgg8} alt="Product 3" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 4 */}
                    <div className="relative group">
                        <img src={imgg14} alt="Product 4" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 5 */}
                    <div className="relative group">
                        <img src={imgg15} alt="Product 5" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 6 */}
                    <div className="relative group">
                        <img src={imgg19} alt="Product 6" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
                    ...
                    {/* Product 7 */}
                    <div className="relative group">
                        <img src={imgg20} alt="Product 7" className="w-full rounded-lg shadow-md" />
                        <div className="text-center mt-3">
